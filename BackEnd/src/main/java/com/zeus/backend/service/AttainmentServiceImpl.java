...
public class AttainmentServiceImpl implements AttainmentService {
	...
	@Override
	public List<Attainment> getAttainmentsByUserIdAndDate(String user_id, String attainment_duration,
	...
	public Map<String, String> getMonthlyLongTermAttainmentRate() {
		Map<String, String> result = attainmentMapper.getMonthlyLongTermAttainmentRate();
        return new LinkedHashMap<>(result);
	}

	@Override
	public Map<String, String> getMonthlyShortTermAttainmentRate() {
		Map<String, String> result = attainmentMapper.getMonthlyShortTermAttainmentRate();
		return new LinkedHashMap<>(result);
	}
